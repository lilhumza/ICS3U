 ...
 * @author nanth
 */
public class ICS3UES19July24thDemo extends JFrame  implements ActionListener{
    ...
    int [] intAge;
    int index = 0;
    ImageIcon icon = new ImageIcon("pizza.jpg");//adding images
   
    public ICS3UES19July24thDemo(){
    ...
    public void actionPerformed (ActionEvent e){
       ...
       if(e.getActionCommand().equals("Average")){
           ...
           for(int i = 0; i < intAge.length; i++){
               intTotal = intTotal + intAge[i];
           }
           lblNameDisplay.setText(""+(intTotal/10.0));
       }
    }
}
